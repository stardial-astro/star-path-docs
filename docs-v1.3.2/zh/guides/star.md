...
![选择行星](../../../assets/images/v1.3.2/image-44.png){ .img-light } ![选择行星](../../../assets/images/v1.3.2/image-45.png){ .img-dark }
...
![检索 HIP](../../../assets/images/v1.3.2/image-46.png){ .img-light } ![检索 HIP](../../../assets/images/v1.3.2/image-47.png){ .img-dark }
...
![无赤经赤纬数据](../../../assets/images/v1.3.2/image-48.png){ .img-light } ![无赤经赤纬数据](../../../assets/images/v1.3.2/image-49.png){ .img-dark } ![无编号](../../../assets/images/v1.3.2/image-50.png){ .img-light } ![无编号](../../../assets/images/v1.3.2/image-51.png){ .img-dark }
...
![通过星名检索 HIP](../../../assets/images/v1.3.2/image-52.png){ .img-light } ![通过星名检索 HIP](../../../assets/images/v1.3.2/image-53.png){ .img-dark }
...
![通过中文星名检索 HIP](../../../assets/images/v1.3.2/image-54.png){ .img-light } ![通过中文星名检索 HIP](../../../assets/images/v1.3.2/image-55.png){ .img-dark }
...
![HMS 和 DMS 格式赤经赤纬](../../../assets/images/v1.3.2/image-56.png){ .img-light } ![HMS 和 DMS 格式赤经赤纬](../../../assets/images/v1.3.2/image-57.png){ .img-dark }
或都使用**十进制小数**：
![十进制小数格式赤经赤纬](../../../assets/images/v1.3.2/image-58.png){ .img-light } ![十进制小数格式赤经赤纬](../../../assets/images/v1.3.2/image-59.png){ .img-dark }
