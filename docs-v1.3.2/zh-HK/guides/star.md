...
![選擇行星](../../../assets/images/v1.3.2/image-60.png){ .img-light } ![選擇行星](../../../assets/images/v1.3.2/image-61.png){ .img-dark }
...
![檢索 HIP](../../../assets/images/v1.3.2/image-62.png){ .img-light } ![檢索 HIP](../../../assets/images/v1.3.2/image-63.png){ .img-dark }
...
![無赤經赤緯數據](../../../assets/images/v1.3.2/image-64.png){ .img-light } ![無赤經赤緯數據](../../../assets/images/v1.3.2/image-65.png){ .img-dark } ![無編號](../../../assets/images/v1.3.2/image-66.png){ .img-light } ![無編號](../../../assets/images/v1.3.2/image-67.png){ .img-dark }
...
![通過星名檢索 HIP](../../../assets/images/v1.3.2/image-68.png){ .img-light } ![通過星名檢索 HIP](../../../assets/images/v1.3.2/image-69.png){ .img-dark }
...
![通過中文星名檢索 HIP](../../../assets/images/v1.3.2/image-70.png){ .img-light } ![通過中文星名檢索 HIP](../../../assets/images/v1.3.2/image-71.png){ .img-dark }
...
![HMS 和 DMS 格式赤經赤緯](../../../assets/images/v1.3.2/image-72.png){ .img-light } ![HMS 和 DMS 格式赤經赤緯](../../../assets/images/v1.3.2/image-73.png){ .img-dark }
或都使用**十進制小數**：
![十進制小數格式赤經赤緯](../../../assets/images/v1.3.2/image-74.png){ .img-light } ![十進制小數格式赤經赤緯](../../../assets/images/v1.3.2/image-75.png){ .img-dark }
