...
[ISO 8601: 日期和時間格式](external:https://www.iso.org/iso-8601-date-and-time-format.html)
...
[NASA 關於公曆紀元表示方法的約定](external:https://eclipse.gsfc.nasa.gov/SEhelp/dates.html) 解釋了使用 `BCE/CE` 代替 `BC/AD` 的理由：
