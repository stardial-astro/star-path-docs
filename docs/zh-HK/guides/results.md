...
::: callout info "關於速度"
由於本項目非商用，我們服務器的搭載使用的是免費計劃。因此，連接和運算時間偶爾會比預計長一些，但通常最多等待幾秒鐘即可獲得結果。
:::
...
::: collapsible "圖像示例"
![圖像](../../../assets/images/latest/4-01_zh-HK_0.png){ .img-light } ![圖像](../../../assets/images/latest/4-01_zh-HK_1.png){ .img-dark }

::: callout tip
按住 `Alt` 鍵（macOS 系統上按 `⌥ Option` 鍵）可放大光標所在位置。
:::
:::

::: callout info "如果天體未升起"
如果對所選地點和日期，查詢的天體未曾升起，將顯示提示：
![Star Never Rises](../../../assets/images/latest/4-02_zh-HK_0.png){ .img-light } ![Star Never Rises](../../../assets/images/latest/4-02_zh-HK_1.png){ .img-dark }
:::

### 農曆日期 {#chinese-calendar-tooltip}

如果查詢的日期可被轉換為農曆，該農曆日期將顯示為浮動提示。光標懸停在格里曆或儒略曆日期上（在移動端則輕觸）即可看到提示。
![Date in Chinese calendar](../../../assets/images/latest/4-03_zh-HK_0.png){ .img-light } ![Date in Chinese calendar](../../../assets/images/latest/4-03_zh-HK_1.png){ .img-dark }
...
![表格](../../../assets/images/latest/4-04_zh-HK_0.png){ .img-light } ![表格](../../../assets/images/latest/4-04_zh-HK_1.png){ .img-dark }

::: callout tip "標記點説明"
光標懸停在 **ⓘ** 符號上（在移動端則輕觸）可打開相應標記點的解釋。參見[慣例約定][Conventions]部分。
![標記點説明](../../../assets/images/latest/4-05_zh-HK_0.png){ .img-light } ![標記點説明](../../../assets/images/latest/4-05_zh-HK_1.png){ .img-dark }
