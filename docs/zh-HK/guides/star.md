...
如上所示，如果候選條目的數據中包含任何[拜耳命名法][Bayer designation]星名、[固有名稱][proper name]或中文名，將同時顯示在編號旁以供參考。
...
可通過輸入[國際天球參考系（ICRS）][ICRS]的[赤經][RA]和[赤緯][Dec]座標來跟蹤天球上一個固定的點。
