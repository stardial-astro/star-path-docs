...
![選擇行星](../../../assets/images/latest/3-01_zh-HK_0.png){ .img-light } ![選擇行星](../../../assets/images/latest/3-01_zh-HK_1.png){ .img-dark }
...
![檢索 HIP](../../../assets/images/latest/3-02_zh-HK_0.png){ .img-light } ![檢索 HIP](../../../assets/images/latest/3-02_zh-HK_1.png){ .img-dark }
...
![無赤經赤緯數據](../../../assets/images/latest/3-03_zh-HK_0.png){ .img-light } ![無赤經赤緯數據](../../../assets/images/latest/3-03_zh-HK_1.png){ .img-dark } ![無編號](../../../assets/images/latest/3-04_zh-HK_0.png){ .img-light } ![無編號](../../../assets/images/latest/3-04_zh-HK_1.png){ .img-dark }
...
![通過星名檢索 HIP](../../../assets/images/latest/3-05_zh-HK_0.png){ .img-light } ![通過星名檢索 HIP](../../../assets/images/latest/3-05_zh-HK_1.png){ .img-dark }
...
![通過中文星名檢索 HIP](../../../assets/images/latest/3-06_zh-HK_0.png){ .img-light } ![通過中文星名檢索 HIP](../../../assets/images/latest/3-06_zh-HK_1.png){ .img-dark }
...
![HMS 和 DMS 格式赤經赤緯](../../../assets/images/latest/3-07_zh-HK_0.png){ .img-light } ![HMS 和 DMS 格式赤經赤緯](../../../assets/images/latest/3-07_zh-HK_1.png){ .img-dark }
或都使用**十進制小數**：
![十進制小數格式赤經赤緯](../../../assets/images/latest/3-08_zh-HK_0.png){ .img-light } ![十進制小數格式赤經赤緯](../../../assets/images/latest/3-08_zh-HK_1.png){ .img-dark }
