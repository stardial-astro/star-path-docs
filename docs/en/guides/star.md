...
![Select Planet](../../../assets/images/latest/3-01_en_0.png){ .img-light } ![Select Planet](../../../assets/images/latest/3-01_en_1.png){ .img-dark }
...
![HIP by Number](../../../assets/images/latest/3-02_en_0.png){ .img-light } ![HIP by Number](../../../assets/images/latest/3-02_en_1.png){ .img-dark }
...
![No radec](../../../assets/images/latest/3-03_en_0.png){ .img-light } ![No radec](../../../assets/images/latest/3-03_en_1.png){ .img-dark } ![No entry](../../../assets/images/latest/3-04_en_0.png){ .img-light } ![No entry](../../../assets/images/latest/3-04_en_1.png){ .img-dark }
...
![HIP by Proper Name or Bayer Designation](../../../assets/images/latest/3-05_en_0.png){ .img-light } ![HIP by Proper Name or Bayer Designation](../../../assets/images/latest/3-05_en_1.png){ .img-dark }
...
![HIP by Pinyin](../../../assets/images/latest/3-06_en_0.png){ .img-light } ![HIP by Pinyin](../../../assets/images/latest/3-06_en_1.png){ .img-dark }
...
![Radec in HMS and DMS](../../../assets/images/latest/3-07_en_0.png){ .img-light } ![Radec in HMS and DMS](../../../assets/images/latest/3-07_en_1.png){ .img-dark }
or both in **decimal degrees**:
![Radec in decimal degrees](../../../assets/images/latest/3-08_en_0.png){ .img-light } ![Radec in decimal degrees](../../../assets/images/latest/3-08_en_1.png){ .img-dark }
