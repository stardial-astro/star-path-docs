...
![Select Planet](../../../assets/images/latest/image-28.png){ .img-light } ![Select Planet](../../../assets/images/latest/image-29.png){ .img-dark }
...
![HIP by Number](../../../assets/images/latest/image-30.png){ .img-light } ![HIP by Number](../../../assets/images/latest/image-31.png){ .img-dark }
...
![HIP by Proper Name or Bayer Designation](../../../assets/images/latest/image-36.png){ .img-light } ![HIP by Proper Name or Bayer Designation](../../../assets/images/latest/image-37.png){ .img-dark }
...
![HIP by Pinyin](../../../assets/images/latest/image-38.png){ .img-light } ![HIP by Pinyin](../../../assets/images/latest/image-39.png){ .img-dark }
...
![Radec in HMS and DMS](../../../assets/images/latest/image-40.png){ .img-light } ![Radec in HMS and DMS](../../../assets/images/latest/image-41.png){ .img-dark }
or both in **decimal degrees**:
![Radec in decimal degrees](../../../assets/images/latest/image-42.png){ .img-light } ![Radec in decimal degrees](../../../assets/images/latest/image-43.png){ .img-dark }
